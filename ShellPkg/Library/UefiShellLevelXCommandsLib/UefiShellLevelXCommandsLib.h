/** @file
  header file for NULL named library for level X shell command functions.
...
#ifndef _UEFI_SHELL_LEVELX_COMMANDS_LIB_H_
#define _UEFI_SHELL_LEVELX_COMMANDS_LIB_H_
...
extern EFI_HII_HANDLE gShellLevelXHiiHandle;
